...
df_ann = raw.annotations.to_data_frame()
...
labels = epochs.events[:, -1] - 2 #0 - feet, 1 - hands
...
for train_idx, test_idx in cv_split:
    ...
    X_test = csp.transform(epochs_data_train[test_idx][0,:,:].reshape(1,4, 256))
